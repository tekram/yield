...
class ScoreCardsControllerTest < ActionController::TestCase
  ...
  test "should create score_card" do
    assert_difference('ScoreCard.count') do
      post :create, score_card: { exam_code_id: @score_card.exam_code_id, gradeable: @score_card.gradeable, gradeable_type: @score_card.gradeable_type, score: @score_card.score, total: @score_card.total }
    end
  ...
  test "should update score_card" do
    put :update, id: @score_card, score_card: { exam_code_id: @score_card.exam_code_id, gradeable: @score_card.gradeable, gradeable_type: @score_card.gradeable_type, score: @score_card.score, total: @score_card.total }
    assert_redirected_to score_card_path(assigns(:score_card))
  end
